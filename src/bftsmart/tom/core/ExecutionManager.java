...
public final class ExecutionManager {
    ...
    private Backup backup; // Acceptor role of the PaW algorithm
    private Primary primary; // Proposer role of the PaW algorithm
        ...
        if (isRetrievingState || // Is this replica retrieving a state?
            ...
            if (stopped) {//just an optimization to avoid calling the lock in normal case
                ...
                if (isRetrievingState || 
                   ...
                   /*************************************************7.13**********************************************/
                        (inExec == -1 && msg.getType() != MessageFactory.PREPARE)) {//PROPOSE)) { //not propose message for the next consensus
                    /**********************************************************************************************/
